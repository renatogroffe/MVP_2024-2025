...
| ------------ | ---- | ---- |
| Example of consuming a REST API for access counting protected by encrypted tokens (JWE) in .NET 8 and using the Refit and Jose libraries, with failure handling through the Polly library. | https://github.com/renatogroffe/DotNet8-Refit-JWE-Polly-Jose_ConsumoAPIContagem |
